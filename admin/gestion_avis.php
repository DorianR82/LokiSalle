...
$r = execute_requete('SELECT a.id_avis, a.id_membre, m.email, s.id_salle, s.titre, a.commentaire, a.note, a.date_enregistrement
                     FROM avis a, membre m, salle s WHERE a.id_membre = m.id_membre AND a.id_salle = s.id_salle');
...
$content .=
        '<div class="row mt-5">
                <div class="col-md-4">
                        ID membre : '.$id_membre.' - '.$email.'
                </div>
                <div class="col-md-4">
                        ID salle : '.$id_membre.' - '.$titre.'
                </div>
                <div class="col-md-4">
                        ID avis : '.$id_avis.'
                </div>
