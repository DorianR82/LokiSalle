...
if(!empty($_POST)){
        ...
        $dateA = date_create_from_format('d/m/Y H:i:s',$_POST['date_arrivee']);
        $arrivee =  date_format($dateA, 'Y-m-d H:i:s');

        $dateD = date_create_from_format('d/m/Y H:i:s',$_POST['date_depart']);
        $depart =  date_format($dateD, 'Y-m-d H:i:s');
...
$prix = '';
        ...
        <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                        ...
                        <input type="text" name="date_arrivee" class="form-control" id="date_arrivee" value="'.$date_arrivee.'" placeholder="00/00/0000 00:00:00">
                </div>
                <div class="form-group">
                        <label for="date_depart">Date Départ</label><br>
                        <input type="text" name="date_depart" class="form-control" id="date_depart" value="'.$date_depart.'" placeholder="00/00/0000 00:00:00">
                </div>
                <div class="form-group">
