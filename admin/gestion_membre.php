...
if($_POST){
        debug($_POST);
        execute_requete(" UPDATE membre SET pseudo = '$_POST[pseudo]', nom = '$_POST[nom]', prenom = '$_POST[prenom]', email = '$_POST[email]', civilite = '$_POST[civilite]', statut = '$_POST[statut]' WHERE id_membre = '$_GET[id_membre]' ");
...
$content .= '<form method="post">
        ...
        <div class="form-group">
                ...
                <select class="form-control" id="sexe" name="civilite">
                        ...
                        if($civilite == 'F')
                        $content .= ' selected';
                        $content .= '>Madame</option>';
                        $content .= '<option value="M" ';
                        if($civilite == 'M')
                        $content .= ' selected';
                        $content .='>Monsieur</option>
                </select>
        </div>
        <div class="form-group">
